...
On-demand MicroVM termination: the authorized API route, the per-user
scoping rule, the confirmation and post-terminate UI state, and the teardown
contract that stops reconnect traffic against a dead endpoint.
